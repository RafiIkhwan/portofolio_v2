...
import BekangAD_1 from './img/bekangad_1.png'
import BekangAD_2 from './img/bekangad_2.png'
import BekangAD_3 from './img/bekangad_3.png'
import BekangAD_4 from './img/bekangad_4.png'
import BekangAD_5 from './img/bekangad_5.png'

import LegalPlus_1 from './img/legalplus_1.png'
import LegalPlus_2 from './img/legalplus_2.png'
import LegalPlus_3 from './img/legalplus_3.png'
import LegalPlus_4 from './img/legalplus_4.png'
import LegalPlus_5 from './img/legalplus_5.png'
import LegalPlus_6 from './img/legalplus_6.png'
import LegalPlus_7 from './img/legalplus_7.png'

import TemanSehat from './img/TemanSehat.png'
import TemanSehat_1 from './img/TemanSehat_1.png'
import TemanSehat_2 from './img/TemanSehat_2.png'
import TemanSehat_3 from './img/TemanSehat_3.png'
...
export const projectData = [
    {
      ...
      githubUrl: '',
      builtWith: {
        programmingLanguage: ['PHP', 'HTML', 'CSS'],
        framework: ['Bootstrap'],
        database: ['MySQL'],
    ...
    },
    {
      ...
      projectUrl: 'https://legalplus.co.id/',
      githubUrl: '',
      builtWith: {
        programmingLanguage: ['JavaScript', 'HTML', 'CSS'],
        framework: ['ReactJs', 'TailwindCSS'],
        database: ['MongoDB'],
        toolsAndOther: ['Visual Studio Code', 'NodeJs', 'Bun', 'Git'],
      },
      date: '2024-07-30',
    },
    {
      ...
      projectUrl: 'https://sisfobekangad.cafstechnology.id/admin/auth/signin',
      githubUrl: '',
      builtWith: {
        programmingLanguage: ['PHP', 'HTML', 'CSS'],
        framework: ['Laravel', 'Bootstrap 5'],
        database: ['PostgreSQL'],
        toolsAndOther: ['Visual Studio Code', 'Git'],
      },
      date: '2024-05-28',
    },
    {
    ...
    },
    {
      ...
      builtWith: {
        ...
        database: ['MySQL'],
        toolsAndOther: ['Visual Studio Code', 'Figma',  'ReduxJs', 'Prisma', 'Git', 'NodeJs'],
      },
      date: '2023-12-07',
    },
    // {
...
export const listConfig = [
  {
    ...
    items: [
      ...
      { 
        ...
        content: 'Plan, manage, and communicate to keep your projects on track !', 
        context: 0 
      }
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Hono', content: '', context: 2 },
    ],
  },
  {
    id: 'databaseList',
    items: [
      { title: 'MySQL', content: '', context: 3 },
      { title: 'PostgreSQL', content: '', context: 3 },
      { title: 'MongoDB', content: '', context: 3 },
    ],
  },
  {
    id: 'toolsOtherList',
    items: [
      ...
      { title: 'Node.js', content: '', context: 4 },
      { title: 'Bun', content: '', context: 4 },
      { title: 'Git', content: '', context: 4 },
    ],
  },
];